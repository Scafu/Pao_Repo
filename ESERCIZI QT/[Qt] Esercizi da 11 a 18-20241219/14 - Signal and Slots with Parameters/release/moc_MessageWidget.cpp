...
static constexpr auto qt_meta_stringdata_ZN13MessageWidgetE = QtMocHelpers::stringData(
    "MessageWidget",
    "updateLabel",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13MessageWidgetE[] = {
...
Q_CONSTINIT const QMetaObject MessageWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13MessageWidgetE.offsetsAndSizes,
    qt_meta_data_ZN13MessageWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13MessageWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *MessageWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13MessageWidgetE.stringdata0))
